 ...
 *  : 입력시, 자료형이 입력메소드와 일치하지 않아서 발생하는 예외상황
 *  ex) nextInt()에 대하여 정수를 입력하지 않고 자료형(문자 등)을 입력한 경우
 */
	...
	public static void main(String[] args) {
		...
		do {
			...
			try {
				...
				sc.next();
				System.err.println("(0~7) 번 사이의 정수를 입력하세요");
				continue;
			}
			// 종료 조건
			if(menuNo == 0) break;
