...
public class StudentTest {
	...
	public static void main(String[] args) {
		...
		student.major = "전기전자과";
		int scores[] = {100, 85, 90, 100, 70}; // 학생1의 성적
		...
		student2.name = "문봉현";
		student2.age = 27;
		student2.stdNo = "16100266";
		student2.major = "컴퓨터소프트웨어과";
		int scores2[] = {100, 80, 90, 95, 85}; // 학생1의 성적
		...
		System.out.println("학생2 - 중간고사 점수 : " + student2.getAverage(100, 80));
		System.out.println("학생2 - 기말고사 점수 : " + student2.getAverage(90, 95, 85));
