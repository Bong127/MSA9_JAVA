...
public class SmartTelevision implements SmartRemoteControl, Searchable {
	...
	public int channelSearch(String keyword) {
		...
		switch (keyword) {
			...
			case "KBS": channel = 5; break;
			case "MBC": channel = 5; break;
			case "Mnet": channel = 5; break;
			case "ENA": channel = 5; break;
		}
		return channel;
	}
	@Override
	public String[] contentSearch(String keyword) {
		...
		String[] recommendCotend = {"메타 코미디 클럽", "경영자들", "피식대학", "개그야", "개콘", "먹방"};
		...
		case "아이돌" : 
			...
			break;
		default:
			choiceContents = recommendCotend;
			break;
		}
